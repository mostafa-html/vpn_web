# Generated by Django 5.0.14 on 2026-06-11 09:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "admin_password",
                    models.CharField(
                        help_text="MUST be encrypted at rest later.", max_length=255
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "target_role",
                    models.CharField(
                        choices=[("SUB_ADMIN", "Sub Admin"), ("END_USER", "End User")],
                        max_length=20,
                    ),
                ),
                ("price_per_gb", models.DecimalField(decimal_places=4, max_digits=10)),
                ("price_per_day", models.DecimalField(decimal_places=4, max_digits=10)),
                (
                    "specific_user",
                    models.ForeignKey(
                        blank=True,
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("server", "xui_inbound_id"), name="unique_inbound_per_server"
            ),
        ),
    ]
